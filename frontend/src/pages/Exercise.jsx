      ...
      <div className="exercise-page">
        ...
        <div className="music-player">
          <div className="image-container">
            <img src={data.cover} alt="calming background" className="main-img" />
          </div>
